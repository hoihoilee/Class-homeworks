...
static std::string const __str_literal_8("==========================================\n", 43u);
static std::string const __str_literal_5("Executed Instructions : %d\n", 27u);
static std::string const __str_literal_4("Number of Cycles      : %d\n", 27u);
static std::string const __str_literal_9("Program Exceeded the maximum cycle %d\n", 38u);
static std::string const __str_literal_7("Result                :     FAILED %d\n", 38u);
static std::string const __str_literal_6("Result                :     PASSED\n", 35u);
...
void MOD_mkTestBench::RL_run()
{
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_proc_cpuToHost_2_BITS_131_TO_128_3_EQ_14___d17)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_4, DEF__read__h123);
    if (DEF_proc_cpuToHost_2_BITS_131_TO_128_3_EQ_14___d17)
    ...
    if (DEF_proc_cpuToHost_2_BITS_131_TO_128_3_EQ_14_7_AND_ETC___d20)
      dollar_fwrite(sim_hdl, this, "32,s", 2147483650u, &__str_literal_6);
    if (DEF_proc_cpuToHost_2_BITS_131_TO_128_3_EQ_14_7_AND_ETC___d22)
      dollar_fwrite(sim_hdl, this, "32,s,64", 2147483650u, &__str_literal_7, DEF_data__h350);
    if (DEF_proc_cpuToHost_2_BITS_131_TO_128_3_EQ_14___d17)
