...
void MOD_mkTestBench::RL_run()
{
  ...
  DEF_proc_cpuToHost_2_BITS_63_TO_0___d22 = primExtract64(64u, 132u, DEF_ab__h341, 32u, 63u, 32u, 0u);
  DEF_idx__h348 = DEF_ab__h341.get_bits_in_word8(4u, 0u, 4u);
  DEF_proc_cpuToHost_2_BITS_127_TO_64_5_EQ_0___d18 = DEF_data__h350 == 0llu;
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_proc_cpuToHost_2_BITS_131_TO_128_3_EQ_14_7_AND_ETC___d21)
      dollar_fwrite(sim_hdl, this, "32,s,64", 2147483650u, &__str_literal_6, DEF_data__h350);
    if (DEF_proc_cpuToHost_2_BITS_131_TO_128_3_EQ_14___d17)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_7, DEF__read__h123);
    if (DEF_proc_cpuToHost_2_BITS_131_TO_128_3_EQ_14___d17)
